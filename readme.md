...
Поддерживаются досрочные платежи и режим рассрочки (0%).
...
- Досрочные платежи с выбором стратегии (уменьшать срок или платеж).
- Режим рассрочки: скрывает ставку и считает 0%.
...
- Экспорт: `/export` сохраняет `mortgage_schedule.xlsx`.
...
7. Досрочные платежи уменьшают срок или платеж в зависимости от выбранной стратегии.
